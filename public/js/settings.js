...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function startRenameStream() {
    ...
    renameEventSource.onerror = () => {
      console.error('Rename stream error');
    };
  }
  ...
  function startMoveStream() {
    ...
    moveEventSource.onerror = () => {
      console.error('Move stream error');
    };
  }
  ...
  if (renameClearBtn) {
    renameClearBtn.addEventListener('click', async () => {
      ...
      try {
        ...
        console.error('Failed to clear rename output:', error);
      }
    });
  }
  ...
  if (moveClearBtn) {
    moveClearBtn.addEventListener('click', async () => {
      ...
      try {
        ...
        console.error('Failed to clear move output:', error);
      }
    });
  }
