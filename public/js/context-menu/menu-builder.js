 ...
 */
import { ICONS as GlobalIcons, state } from '../globals.js';
...
const ICONS = {
  ...
  SUCCESS: GlobalIcons.READ,

  // Download arrow icon
  DOWNLOAD: GlobalIcons.DOWNLOAD,

  // Eye/Read icon
  EYE: GlobalIcons.UNREAD,
...
// Named exports
export { ICONS, positionContextMenu, attachCloseHandler, closeContextMenu };

// Backward-compatible bundle object
export const ContextMenuBuilder = { ICONS, positionContextMenu, attachCloseHandler, closeContextMenu };

// Register on state for cross-module access
state.ContextMenuBuilder = ContextMenuBuilder;
