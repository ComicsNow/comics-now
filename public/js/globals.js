...
const latestConvertedButton = document.getElementById('latest-converted-btn');
const latestAddedCountSpan = document.getElementById('latest-added-count');
const latestConvertedCountSpan = document.getElementById('latest-converted-count');
...
const PRELOAD_AHEAD_COUNT = 7; // Number of pages to preload ahead of the current one
let downloadQueue = [];
